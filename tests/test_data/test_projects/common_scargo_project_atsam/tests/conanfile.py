...
class Common_scargo_project_atsamTestConan(ConanFile):  # type: ignore[misc, no-any-unimported]
    name = "common_scargo_project_atsam_test"
    version = "0.1.0"
    settings = "os", "compiler", "build_type", "arch"
    description = "Tests for common_scargo_project_atsam"
