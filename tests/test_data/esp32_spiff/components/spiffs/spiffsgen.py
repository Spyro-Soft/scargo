...
class SpiffsObjLuPage(SpiffsPage):
    def __init__(self, bix, build_config):  # type: (int, SpiffsBuildConfig) -> None
        ...
        self.obj_ids = list()  # type: typing.List[ObjIdsItem]  # type: ignore
...
class SpiffsObjIndexPage(SpiffsObjPageWithIdx):
    def __init__(
        self, obj_id, span_ix, size, name, build_config
...
class SpiffsObjDataPage(SpiffsObjPageWithIdx):
    def __init__(
        self, offset, obj_id, span_ix, contents, build_config
...
class SpiffsBlock:
    ...
    def begin_obj(
        self, obj_id, size, name, obj_index_span_ix=0, obj_data_span_ix=0
