...
def generate_tests(config: Config) -> None:
    ...
    tests_template_dir = Path(SCARGO_PKG_PATH, "jinja", "test_templates")
    project_path = get_project_root()

    # List of files to generate once (template_path, output_path)
    gen_once_file_list = [
        ("test_templates/CMakeLists-ut.txt.j2", "tests/ut/CMakeLists.txt"),
        ("test_templates/CMakeLists-it.txt.j2", "tests/it/CMakeLists.txt"),
        ("test_templates/CMakeLists-mocks.txt.j2", "tests/mocks/CMakeLists.txt"),
    ]
    ...
    create_file_from_template(
        "test_templates/CMakeLists-test.txt.j2",
